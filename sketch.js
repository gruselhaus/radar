...
const toBeChecked = [RegExp(/^LUA\d*/),RegExp(/^WLDLIFE\d*/),RegExp(/^DFS\d*/),RegExp(/^RM\d*/),RegExp(/^SIPO\d*/),RegExp(/^V\d*/), RegExp(/^FRA\d*/), RegExp(/^EL\d*/), RegExp(/^APT\d*/), RegExp(/^LEOS\d*/), RegExp(/^FF\d*/)];
